...
//    public final String PREFERENCE_DAYS_LEFT = "DaysLeft";
    ...
    public void saveString(String value, String nameOfPreference) {
        SharedPreferences.Editor editor = editor();
        editor.putString(nameOfPreference, value);
        editor.apply();
    }
...
//    }
    ...
    public String retrieveString(String name, String backUp){
